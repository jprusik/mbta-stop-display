...
export const PREDICTIONS_REQUEST_URL = `https://api-v3.mbta.com/predictions/?filter[route]=${ROUTE}&filter[stop]=${ROUTE_STOP}&sort=direction_id,arrival_time`;

export const SCHEDULE_REQUEST_URL = `https://api-v3.mbta.com/schedules/?filter[route]=${ROUTE}&filter[stop]=${ROUTE_STOP}&include=${REQUEST_INCLUDES.join(',')}&sort=direction_id,arrival_time`;
